...
import demo from '@site/static/img/elements/alertdialog/demo.png'
import demoGif from '@site/static/img/elements/alertdialog/demo.gif'
import demo2 from '@site/static/img/elements/alertdialog/demo2.png'
