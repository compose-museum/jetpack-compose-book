...
import text from '@site/static/img/elements/text/demo.png'
import demo from '@site/static/img/elements/text/text.png'
import demo2 from '@site/static/img/elements/text/text2.png'
import demo3 from '@site/static/img/elements/text/text3.png'
import demo4 from '@site/static/img/elements/text/text4.png'
import demo5 from '@site/static/img/elements/text/text5.png'
import demo6 from '@site/static/img/elements/text/text6.png'
import demo7 from '@site/static/img/elements/text/text7.png'
import demo8 from '@site/static/img/elements/text/text8.png'
import demo9 from '@site/static/img/elements/text/text9.png'
import demo10 from '@site/static/img/elements/text/text10.png'
import demo11 from '@site/static/img/elements/text/text11.png'
import demo12 from '@site/static/img/elements/text/text12.png'
import demo13 from '@site/static/img/elements/text/text13.png'
import demo13Gif from '@site/static/img/elements/text/text13.gif'
import demo14 from '@site/static/img/elements/text/text14.png'
import demo14Gif from '@site/static/img/elements/text/text14.gif'
import demo15 from '@site/static/img/elements/text/text15.png'
import demo16 from '@site/static/img/elements/text/text16.png'
import contentAlpha from '@site/static/img/elements/text/content_alpha.png'
...
在第 [#6](./text/#6-可点击的-text) 部分我们已经介绍了可以通过 `AnnotatedString` 来完成在一个 `Text` 中给不同的文字应用不同的样式

在第 [#5](./text/#5-fontfamily-参数) 部分我们已经介绍了可以通过 `Modifier.Clickable()` 来完成检测 `Text` 的点击
...
1. [网站内](../code/elements/text/用户协议.mdx)
2. [Github](https://github.com/compose-museum/compose-tutorial/blob/master/docs/code/elements/text/用户协议.kt)
