...
> Focus是一款帮助你集中的app——为自己的目标建立星球，将时间投入在上面。花在星球上的每一分钟都会被记录，每颗星球可以定制颜色与外观。为了贯彻简单干净不让人分心的设计理念，app采用白灰为主色调。为了不使界面显得单调，所以增加了不少的动画。如果您觉得还可以，希望🙏您能点个Star!!!! [ComposeFocus](https://github.com/Watermelon02/ComposeFocus)
...
因为时间限制所以还有很多想要实现的功能没来得及做，不出意外的话之后会继续修改bug和增加功能。最后再次希望您能够给个点个Star!!!! [ComposeFocus](https://github.com/Watermelon02/ComposeFocus)
