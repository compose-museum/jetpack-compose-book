---
id: compose-scrollable-appbar
title: Compose 伸缩 ToolBar 的实现
---

import nestedScrollGif from '@site/static/img/design/gesture/nested_scroll/nestedScroll.gif'

## 效果图

<img src={nestedScrollGif} width="30%" height="30%" />
