---
id: compose-wan-android
title: wanAndroid 客户端
---
import image1 from '@site/static/img/open-source-project/compose-wan-android/image_1.webp';
import image2 from '@site/static/img/open-source-project/compose-wan-android/image_2.webp';
import image3 from '@site/static/img/open-source-project/compose-wan-android/image_3.webp';
import image4 from '@site/static/img/open-source-project/compose-wan-android/image_4.webp';
import image5 from '@site/static/img/open-source-project/compose-wan-android/image_5.webp';
import image6 from '@site/static/img/open-source-project/compose-wan-android/image_6.webp';
import image7 from '@site/static/img/open-source-project/compose-wan-android/image_7.webp';
import image8 from '@site/static/img/open-source-project/compose-wan-android/image_8.webp';
import image9 from '@site/static/img/open-source-project/compose-wan-android/image_9.webp';
...
| <img src={image1} width="80%" align="center" alt="请添加图片描述"/> | <img src={image2} width="80%" align="center" alt="在这里插入图片描述"/> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| <img src={image3} width="80%" align="center" alt="请添加图片描述"/> | <img src={image4} width="80%" align="center" alt="在这里插入图片描述"/> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| <img src={image5} width="80%" align="center" alt="请添加图片描述"/> | <img src={image6} width="80%" align="center" alt="请添加图片描述"/> |
...
<img src={image7} width="80%" align="center" alt=""/>      
其主要分为以下几部分    
...
<img src={image8} width="80%" align="center" alt=""/>      
...
<img src={image9} width="80%" align="center" alt=""/>      
