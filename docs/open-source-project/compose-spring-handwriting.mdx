---
id: compose-spring-handwriting
title: Compose 实现手写春联效果
---
import image1 from '@site/static/img/open-source-project/compose-spring-handwriting/image_1.webp';
import image2 from '@site/static/img/open-source-project/compose-spring-handwriting/image_2.webp';
import image3 from '@site/static/img/open-source-project/compose-spring-handwriting/image_3.webp';
