...
import demo from '@site/static/img/layout/bottomnavigation/demo.png'
import demoGif from '@site/static/img/layout/bottomnavigation/demo.gif'
import demo3 from '@site/static/img/layout/bottomnavigation/demo3.png'
import demo4 from '@site/static/img/layout/bottomnavigation/demo4.png'
...
<img src = {demo} width = "30%" height = "30%" />
...
<img src = {demo3} width = "30%" height = "30%" />
...
1. [网站内](../code/layout/bottomNavigation/bottomNavigation.md)
2. [Github](https://github.com/compose-museum/compose-tutorial/blob/master/docs/code/layout/bottomNavigation/bottomNavigation.kt)
