...
import demoGif from '@site/static/img/layout/modalbottomsheetlayout/demo.gif'
...
<img src="https://developer.android.com/images/reference/androidx/compose/material/modal-bottom-sheet.png"/>
...
<img src = {demoGif} width = "30%" height = "30%" />
