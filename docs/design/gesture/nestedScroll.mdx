---
id: nestedScroll
title: 嵌套滑动（NestedScroll）
---

import demoGif from '@site/static/img/design/gesture/nested_scroll/smart_refresh.gif'
import nestedScroll from '@site/static/img/design/gesture/nested_scroll/nestedScroll.gif'
import smartRefresh from '@site/static/img/design/gesture/nested_scroll/smart_refresh.gif'
...
<div align="center">
  <img src={smartRefresh} width="30%" height="30%" />
</div>
...
<img src={nestedScroll} width="30%" height="30%" />
...
关于 `ScrollableAppBar` 的定义,请参考[ScrollableAppBar](https://github.com/SakurajimaMaii/ComposeWidget/blob/master/app/src/main/java/com/example/composewidget/ScrollableAppBar.kt)，如果想了解 `ScrollableAppBar` 具体实现过程，请参考[Compose 伸缩ToolBar的实现](https://jetpackcompose.cn/docs/open-source-project/compose-scrollable-appbar)
