...
import demo from '@site/static/img/design/graphics/customDraw/demo1.png'
import demo2 from '@site/static/img/design/graphics/customDraw/demo2.png'
import demo3Gif from '@site/static/img/design/graphics/customDraw/demo3.gif'
...
```
<div align="center">
    <img src={demo3Gif} width="50%" height="50%"/>
</div>
