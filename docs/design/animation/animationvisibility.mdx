...
title: AnimationVisibility（实验性）
---

import demo from '@site/static/img/design/animation/animatedVisibility/carbon.png'
import demoGif from '@site/static/img/design/animation/animatedVisibility/demo.gif'
import demo2Gif from '@site/static/img/design/animation/animatedVisibility/demo2.gif'
import demo3Gif from '@site/static/img/design/animation/animatedVisibility/demo3.gif'
