---
id: tutorial
title: 初识 Jetpack Compose
---

import demo from '@site/static/img/tutorial/demo.gif'
import demoPng from '@site/static/img/tutorial/demo.png'
import demo2 from '@site/static/img/tutorial/demo2.png'
import demo3 from '@site/static/img/tutorial/demo3.png'
import demo3Gif from '@site/static/img/tutorial/demo3.gif'
import demo4 from '@site/static/img/tutorial/demo4.gif'
import demo5 from '@site/static/img/tutorial/demo5.png'
import demo5Gif from '@site/static/img/tutorial/demo5.gif'
import demo6 from '@site/static/img/tutorial/demo6.png'
import demo6Gif from '@site/static/img/tutorial/demo6.gif'
import demo7Gif from '@site/static/img/tutorial/demo7.gif'
import demo8 from '@site/static/img/tutorial/demo8.png'
import demo9 from '@site/static/img/tutorial/demo9.png'
import demo10 from '@site/static/img/tutorial/demo10.png'
import demo11 from '@site/static/img/tutorial/demo11.png'
import demo12 from '@site/static/img/tutorial/demo12.png'
import demo13 from '@site/static/img/tutorial/demo13.png'
import demo14 from '@site/static/img/tutorial/demo14.png'
import demo15 from '@site/static/img/tutorial/demo15.png'

`Jetpack Compose` 是一个用于构建原生 `Android UI` 的现代工具包。`Jetpack Compose` 用更少的代码、强大的工具和直观的 `Kotlin API` 简化并加速了 `Android` 上的 `UI` 开发。

在这章中，你将用声明式函数构建一个简单的 `UI` 组件。你可以不用编辑任何 `XML` 布局或使用布局编辑器。相反，你将调用 `Jetpack Compose` 函数来说明你想要的元素，剩下的就由 `Compose` 编译器来完成。
...
<img src = {demo} width = "600" height = "600" />
...
<img src = {demo4} width = "600" height = "600" />
...
你可以在[这里](https://gist.github.com/whitescent/d7665503600d0499bf96a9521721c801)获取 `MsgData` 的代码
...
|基础|设计|
|----|----|
|[Compose 编程思想](https://developer.android.com/jetpack/compose/mental-model)|[布局概述](https://developer.android.com/jetpack/compose/layouts/basics)|
|[状态管理](https://developer.android.com/jetpack/compose/state)|[动画概述](design/animation/overview)|
|[生命周期](https://developer.android.com/jetpack/compose/lifecycle)|[主题概述](design/theme/meetMaterialTheme)|
|[负面影响](https://developer.android.com/jetpack/compose/side-effects)|[手势概述](design/gesture/overview/)|
|[架构分层](https://developer.android.com/jetpack/compose/layering)|[列表概述](design/lists/overview/)|
