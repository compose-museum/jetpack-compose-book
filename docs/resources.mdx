...
|依赖名|版本|
|------|-----|
|GradlePlugin（稳定版 Android Studio 北极狐可用的最新版本）|[7.0.3](https://mvnrepository.com/artifact/com.android.tools.build/gradle?repo=google)|
|GradlePlugin (Android Studio Canary 等版本可用的最新版本)|[7.1.0-alpha13](https://mvnrepository.com/artifact/com.android.tools.build/gradle?repo=google)|
|kotlin (Compose 最低支持的 Kotlin 版本，和底下的 Compose 版本对应) |[1.5.31](https://github.com/JetBrains/kotlin/releases)|
|Jetpack Compose（稳定版）|[1.0.5](https://developer.android.com/jetpack/androidx/releases/compose)|
|NavigationCompose|[2.4.0-alpha10](https://developer.android.com/jetpack/androidx/releases/navigation)|
